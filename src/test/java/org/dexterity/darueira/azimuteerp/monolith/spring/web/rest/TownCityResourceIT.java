...
import org.dexterity.darueira.azimuteerp.monolith.spring.repository.TownCityRepository;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.TownCityService;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.dto.TownCityDTO;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.mapper.TownCityMapper;
...
class TownCityResourceIT {
    ...
    void partialUpdateTownCityWithPatch() throws Exception {
        ...
        partialUpdatedTownCity.acronym(UPDATED_ACRONYM).name(UPDATED_NAME);
