...
import org.dexterity.darueira.azimuteerp.monolith.spring.domain.BusinessUnit;
...
import org.dexterity.darueira.azimuteerp.monolith.spring.repository.BusinessUnitRepository;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.BusinessUnitService;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.dto.BusinessUnitDTO;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.mapper.BusinessUnitMapper;
...
class BusinessUnitResourceIT {
    ...
    void partialUpdateBusinessUnitWithPatch() throws Exception {
        ...
        partialUpdatedBusinessUnit.acronym(UPDATED_ACRONYM).name(UPDATED_NAME).activationStatus(UPDATED_ACTIVATION_STATUS);
