...
import org.dexterity.darueira.azimuteerp.monolith.spring.repository.CustomerTypeRepository;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.dto.CustomerTypeDTO;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.mapper.CustomerTypeMapper;
...
class CustomerTypeResourceIT {
    ...
    void partialUpdateCustomerTypeWithPatch() throws Exception {
        ...
        partialUpdatedCustomerType.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
