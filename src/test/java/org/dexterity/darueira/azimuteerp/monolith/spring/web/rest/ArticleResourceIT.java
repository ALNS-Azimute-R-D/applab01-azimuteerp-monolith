...
import org.dexterity.darueira.azimuteerp.monolith.spring.domain.enumeration.SizeOptionEnum;
...
class ArticleResourceIT {
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.skuCode(UPDATED_SKU_CODE).itemSize(UPDATED_ITEM_SIZE);
