...
import org.dexterity.darueira.azimuteerp.monolith.spring.repository.PaymentGatewayRepository;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.dto.PaymentGatewayDTO;
import org.dexterity.darueira.azimuteerp.monolith.spring.service.mapper.PaymentGatewayMapper;
...
class PaymentGatewayResourceIT {
    ...
    void partialUpdatePaymentGatewayWithPatch() throws Exception {
        ...
        partialUpdatedPaymentGateway.businessHandlerClazz(UPDATED_BUSINESS_HANDLER_CLAZZ);
