...
import org.dexterity.darueira.azimuteerp.monolith.spring.service.mapper.TypeOfOrganizationMapper;
...
class TypeOfOrganizationResourceIT {
    ...
    void partialUpdateTypeOfOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedTypeOfOrganization.acronym(UPDATED_ACRONYM).description(UPDATED_DESCRIPTION);
