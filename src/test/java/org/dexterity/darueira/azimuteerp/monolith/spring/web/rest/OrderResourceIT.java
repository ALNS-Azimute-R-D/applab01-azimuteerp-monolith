...
import static org.dexterity.darueira.azimuteerp.monolith.spring.domain.OrderAsserts.*;
...
import org.dexterity.darueira.azimuteerp.monolith.spring.domain.enumeration.OrderStatusEnum;
...
class OrderResourceIT {
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalDueValue(UPDATED_TOTAL_DUE_VALUE).status(UPDATED_STATUS).activationStatus(UPDATED_ACTIVATION_STATUS);
