...
public class RawAssetProcTmpTestSamples {
    ...
    public static RawAssetProcTmp getRawAssetProcTmpSample1() {
        return new RawAssetProcTmp().id(1L).name("name1").fullFilenamePath("fullFilenamePath1");
    }

    public static RawAssetProcTmp getRawAssetProcTmpSample2() {
        return new RawAssetProcTmp().id(2L).name("name2").fullFilenamePath("fullFilenamePath2");
    }
