...
import de.org.dexterity.azimuteerp.monolith.repository.ArticleRepository;
import de.org.dexterity.azimuteerp.monolith.service.ArticleService;
import de.org.dexterity.azimuteerp.monolith.service.dto.ArticleDTO;
import de.org.dexterity.azimuteerp.monolith.service.mapper.ArticleMapper;
...
class ArticleResourceIT {
    ...
    void getAllArticles() throws Exception {
        ...
        restArticleMockMvc
            ...
            .andExpect(jsonPath("$.[*].customDescription").value(hasItem(DEFAULT_CUSTOM_DESCRIPTION.toString())))
    ...
    void getArticle() throws Exception {
        ...
        restArticleMockMvc
            ...
            .andExpect(jsonPath("$.customDescription").value(DEFAULT_CUSTOM_DESCRIPTION.toString()))
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.customName(UPDATED_CUSTOM_NAME).assetsCollectionUUID(UPDATED_ASSETS_COLLECTION_UUID);
