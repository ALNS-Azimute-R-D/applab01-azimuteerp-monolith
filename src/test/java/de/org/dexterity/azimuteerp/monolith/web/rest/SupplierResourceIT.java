...
class SupplierResourceIT {
    ...
    public static Supplier createEntity(EntityManager em) {
        Supplier supplier = new Supplier()
            ...
            .representativeLastName(DEFAULT_REPRESENTATIVE_LAST_NAME)
            .representativeFirstName(DEFAULT_REPRESENTATIVE_FIRST_NAME)
    ...
    public static Supplier createUpdatedEntity(EntityManager em) {
        Supplier supplier = new Supplier()
            ...
            .representativeLastName(UPDATED_REPRESENTATIVE_LAST_NAME)
            .representativeFirstName(UPDATED_REPRESENTATIVE_FIRST_NAME)
    ...
    void getAllSuppliers() throws Exception {
        ...
        restSupplierMockMvc
            ...
            .andExpect(jsonPath("$.[*].representativeLastName").value(hasItem(DEFAULT_REPRESENTATIVE_LAST_NAME)))
            .andExpect(jsonPath("$.[*].representativeFirstName").value(hasItem(DEFAULT_REPRESENTATIVE_FIRST_NAME)))
    ...
    void getSupplier() throws Exception {
        ...
        restSupplierMockMvc
            ...
            .andExpect(jsonPath("$.representativeLastName").value(DEFAULT_REPRESENTATIVE_LAST_NAME))
            .andExpect(jsonPath("$.representativeFirstName").value(DEFAULT_REPRESENTATIVE_FIRST_NAME))
