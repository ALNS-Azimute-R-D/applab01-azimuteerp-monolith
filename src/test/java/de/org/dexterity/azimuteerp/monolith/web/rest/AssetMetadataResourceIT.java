...
class AssetMetadataResourceIT {
    ...
    public static AssetMetadata createEntity(EntityManager em) {
        AssetMetadata assetMetadata = new AssetMetadata().metadataDetails(DEFAULT_METADATA_DETAILS);
        // Add required entity
        Asset asset;
    ...
    public static AssetMetadata createUpdatedEntity(EntityManager em) {
        AssetMetadata assetMetadata = new AssetMetadata().metadataDetails(UPDATED_METADATA_DETAILS);
        // Add required entity
        Asset asset;
        if (TestUtil.findAll(em, Asset.class).isEmpty()) {
    ...
    void getAllAssetMetadata() throws Exception {
        ...
        restAssetMetadataMockMvc
            ...
            .andExpect(jsonPath("$.[*].metadataDetails").value(hasItem(DEFAULT_METADATA_DETAILS.toString())));
    }
    ...
    void getAssetMetadata() throws Exception {
        ...
        restAssetMetadataMockMvc
            ...
            .andExpect(jsonPath("$.metadataDetails").value(DEFAULT_METADATA_DETAILS.toString()));
    }
    ...
    void putExistingAssetMetadata() throws Exception {
        ...
        updatedAssetMetadata.metadataDetails(UPDATED_METADATA_DETAILS);
    ...
    void fullUpdateAssetMetadataWithPatch() throws Exception {
        ...
        partialUpdatedAssetMetadata.metadataDetails(UPDATED_METADATA_DETAILS);
