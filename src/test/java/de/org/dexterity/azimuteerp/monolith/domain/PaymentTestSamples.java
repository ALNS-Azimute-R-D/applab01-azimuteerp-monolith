...
public class PaymentTestSamples {
    ...
    public static Payment getPaymentSample1() {
        return new Payment().id(1L).installmentNumber(1);
    }

    public static Payment getPaymentSample2() {
        return new Payment().id(2L).installmentNumber(2);
    }

    public static Payment getPaymentRandomSampleGenerator() {
        return new Payment().id(longCount.incrementAndGet()).installmentNumber(intCount.incrementAndGet());
    }
}
