...
public class TypeOfOrganizationTestSamples {
    ...
    public static TypeOfOrganization getTypeOfOrganizationSample1() {
        return new TypeOfOrganization().id(1L).acronym("acronym1").name("name1").businessHandlerClazz("businessHandlerClazz1");
    }

    public static TypeOfOrganization getTypeOfOrganizationSample2() {
        return new TypeOfOrganization().id(2L).acronym("acronym2").name("name2").businessHandlerClazz("businessHandlerClazz2");
    }
