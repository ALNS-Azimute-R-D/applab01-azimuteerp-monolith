...
class StockLevelResourceIT {
    ...
    public static StockLevel createEntity(EntityManager em) {
        StockLevel stockLevel = new StockLevel()
            ...
            .ramainingQuantity(DEFAULT_RAMAINING_QUANTITY)
    ...
    public static StockLevel createUpdatedEntity(EntityManager em) {
        StockLevel stockLevel = new StockLevel()
            ...
            .ramainingQuantity(UPDATED_RAMAINING_QUANTITY)
    ...
    @Test
    @Transactional
    void checkRamainingQuantityIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        stockLevel.setRamainingQuantity(null);
    ...
    void getAllStockLevels() throws Exception {
        ...
        restStockLevelMockMvc
            ...
            .andExpect(jsonPath("$.[*].ramainingQuantity").value(hasItem(DEFAULT_RAMAINING_QUANTITY)))
    ...
    void getStockLevel() throws Exception {
        ...
        restStockLevelMockMvc
            ...
            .andExpect(jsonPath("$.ramainingQuantity").value(DEFAULT_RAMAINING_QUANTITY))
