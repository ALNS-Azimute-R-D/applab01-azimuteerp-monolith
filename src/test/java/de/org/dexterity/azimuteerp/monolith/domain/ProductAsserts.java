...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSupplierIds()).as("check supplierIds").isEqualTo(actual.getSupplierIds()));
    }
    ...
    public static void assertProductUpdatableRelationshipsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSuppliersLists()).as("check suppliersLists").isEqualTo(actual.getSuppliersLists()));
    }
}
