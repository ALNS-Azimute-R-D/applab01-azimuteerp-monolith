...
class TenantResourceIT {
    ...
    public static Tenant createEntity(EntityManager em) {
        Tenant tenant = new Tenant()
            ...
            .mainContactPersonDetails(DEFAULT_MAIN_CONTACT_PERSON_DETAILS)
            .billingDetails(DEFAULT_BILLING_DETAILS)
            .technicalEnvironmentsDetails(DEFAULT_TECHNICAL_ENVIRONMENTS_DETAILS)
            .commonCustomAttributesDetails(DEFAULT_COMMON_CUSTOM_ATTRIBUTES_DETAILS)
    ...
    public static Tenant createUpdatedEntity(EntityManager em) {
        Tenant tenant = new Tenant()
            ...
            .mainContactPersonDetails(UPDATED_MAIN_CONTACT_PERSON_DETAILS)
            .billingDetails(UPDATED_BILLING_DETAILS)
            .technicalEnvironmentsDetails(UPDATED_TECHNICAL_ENVIRONMENTS_DETAILS)
            .commonCustomAttributesDetails(UPDATED_COMMON_CUSTOM_ATTRIBUTES_DETAILS)
    ...
    void getAllTenants() throws Exception {
        ...
        restTenantMockMvc
            ...
            .andExpect(jsonPath("$.[*].mainContactPersonDetails").value(hasItem(DEFAULT_MAIN_CONTACT_PERSON_DETAILS.toString())))
            .andExpect(jsonPath("$.[*].billingDetails").value(hasItem(DEFAULT_BILLING_DETAILS.toString())))
            .andExpect(jsonPath("$.[*].technicalEnvironmentsDetails").value(hasItem(DEFAULT_TECHNICAL_ENVIRONMENTS_DETAILS.toString())))
            .andExpect(jsonPath("$.[*].commonCustomAttributesDetails").value(hasItem(DEFAULT_COMMON_CUSTOM_ATTRIBUTES_DETAILS.toString())))
    ...
    void getTenant() throws Exception {
        ...
        restTenantMockMvc
            ...
            .andExpect(jsonPath("$.mainContactPersonDetails").value(DEFAULT_MAIN_CONTACT_PERSON_DETAILS.toString()))
            .andExpect(jsonPath("$.billingDetails").value(DEFAULT_BILLING_DETAILS.toString()))
            .andExpect(jsonPath("$.technicalEnvironmentsDetails").value(DEFAULT_TECHNICAL_ENVIRONMENTS_DETAILS.toString()))
            .andExpect(jsonPath("$.commonCustomAttributesDetails").value(DEFAULT_COMMON_CUSTOM_ATTRIBUTES_DETAILS.toString()))
