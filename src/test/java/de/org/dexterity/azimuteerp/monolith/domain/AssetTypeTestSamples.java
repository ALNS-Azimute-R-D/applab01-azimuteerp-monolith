...
public class AssetTypeTestSamples {
    ...
    public static AssetType getAssetTypeSample1() {
        return new AssetType().id(1L).acronym("acronym1").name("name1").description("description1").handlerClazzName("handlerClazzName1");
    }

    public static AssetType getAssetTypeSample2() {
        return new AssetType().id(2L).acronym("acronym2").name("name2").description("description2").handlerClazzName("handlerClazzName2");
    }
