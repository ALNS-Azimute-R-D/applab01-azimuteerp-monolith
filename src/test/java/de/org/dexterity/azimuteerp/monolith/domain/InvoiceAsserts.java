...
public class InvoiceAsserts {
    ...
    public static void assertInvoiceUpdatableFieldsEquals(Invoice expected, Invoice actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getOriginalOrderId()).as("check originalOrderId").isEqualTo(actual.getOriginalOrderId()))
    ...
    public static void assertInvoiceUpdatableRelationshipsEquals(Invoice expected, Invoice actual) {
        assertThat(expected)
            ...
            .satisfies(
                e ->
                    assertThat(e.getPreferrablePaymentMethod())
                        .as("check preferrablePaymentMethod")
                        .isEqualTo(actual.getPreferrablePaymentMethod())
            );
    }
}
