...
import de.org.dexterity.azimuteerp.monolith.repository.ProductRepository;
import de.org.dexterity.azimuteerp.monolith.service.ProductService;
import de.org.dexterity.azimuteerp.monolith.service.dto.ProductDTO;
import de.org.dexterity.azimuteerp.monolith.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .supplierIds(DEFAULT_SUPPLIER_IDS);
        // Add required entity
        Brand brand;
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .supplierIds(UPDATED_SUPPLIER_IDS);
        // Add required entity
        Brand brand;
        if (TestUtil.findAll(em, Brand.class).isEmpty()) {
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].supplierIds").value(hasItem(DEFAULT_SUPPLIER_IDS.toString())));
    }
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.supplierIds").value(DEFAULT_SUPPLIER_IDS.toString()));
    }
