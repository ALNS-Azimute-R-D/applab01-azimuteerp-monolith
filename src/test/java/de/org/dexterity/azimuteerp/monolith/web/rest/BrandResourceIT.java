...
import de.org.dexterity.azimuteerp.monolith.repository.BrandRepository;
import de.org.dexterity.azimuteerp.monolith.service.dto.BrandDTO;
import de.org.dexterity.azimuteerp.monolith.service.mapper.BrandMapper;
...
class BrandResourceIT {
    ...
    public static Brand createEntity(EntityManager em) {
        Brand brand = new Brand().acronym(DEFAULT_ACRONYM).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return brand;
    }
    ...
    public static Brand createUpdatedEntity(EntityManager em) {
        Brand brand = new Brand().acronym(UPDATED_ACRONYM).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return brand;
    }
    ...
    void putExistingBrand() throws Exception {
        ...
        updatedBrand.acronym(UPDATED_ACRONYM).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBrandWithPatch() throws Exception {
        ...
        partialUpdatedBrand.acronym(UPDATED_ACRONYM).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
