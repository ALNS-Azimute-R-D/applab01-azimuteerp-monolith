...
describe('Locality e2e test', () => {
  ...
  const localitySample = { acronym: 'bashfull', name: 'times madly apud' };
  ...
  describe('new Locality page', () => {
    ...
    it('should create an instance of Locality', () => {
      cy.get(`[data-cy="acronym"]`).type('hospital');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'hospital');

      cy.get(`[data-cy="name"]`).type('ick');
      cy.get(`[data-cy="name"]`).should('have.value', 'ick');
