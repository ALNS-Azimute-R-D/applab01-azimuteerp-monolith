...
describe('TypeOfPerson e2e test', () => {
  ...
  const typeOfPersonSample = { code: 'but', description: 'induct constant' };
  ...
  describe('new TypeOfPerson page', () => {
    ...
    it('should create an instance of TypeOfPerson', () => {
      cy.get(`[data-cy="code"]`).type('guita');
      cy.get(`[data-cy="code"]`).should('have.value', 'guita');

      cy.get(`[data-cy="description"]`).type('abaft semicolon strawberry');
      cy.get(`[data-cy="description"]`).should('have.value', 'abaft semicolon strawberry');
