...
describe('Category e2e test', () => {
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="acronym"]`).type('expiate fearless whose');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'expiate fearless whose');

      cy.get(`[data-cy="name"]`).type('interview amazing who');
      cy.get(`[data-cy="name"]`).should('have.value', 'interview amazing who');

      cy.get(`[data-cy="description"]`).type('rambler');
      cy.get(`[data-cy="description"]`).should('have.value', 'rambler');

      cy.get(`[data-cy="handlerClazzName"]`).type('yum but');
      cy.get(`[data-cy="handlerClazzName"]`).should('have.value', 'yum but');
