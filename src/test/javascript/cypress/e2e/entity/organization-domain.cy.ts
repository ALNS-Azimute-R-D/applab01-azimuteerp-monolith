...
describe('OrganizationDomain e2e test', () => {
  ...
  // const organizationDomainSample = {"domainAcronym":"ah outside","name":"candidacy productive","isVerified":false,"activationStatus":"INACTIVE"};
  ...
  describe('new OrganizationDomain page', () => {
    ...
    it.skip('should create an instance of OrganizationDomain', () => {
      cy.get(`[data-cy="domainAcronym"]`).type('reprocessing that');
      cy.get(`[data-cy="domainAcronym"]`).should('have.value', 'reprocessing that');

      cy.get(`[data-cy="name"]`).type('past');
      cy.get(`[data-cy="name"]`).should('have.value', 'past');
      ...
      cy.get(`[data-cy="businessHandlerClazz"]`).type('gazump');
      cy.get(`[data-cy="businessHandlerClazz"]`).should('have.value', 'gazump');
