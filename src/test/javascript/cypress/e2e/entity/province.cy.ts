...
describe('Province e2e test', () => {
  ...
  const provinceSample = { acronym: 'exp', name: 'heavily' };
  ...
  describe('new Province page', () => {
    ...
    it('should create an instance of Province', () => {
      cy.get(`[data-cy="acronym"]`).type('ide');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'ide');

      cy.get(`[data-cy="name"]`).type('which loyally');
      cy.get(`[data-cy="name"]`).should('have.value', 'which loyally');
