...
describe('OrganizationAttribute e2e test', () => {
  ...
  describe('new OrganizationAttribute page', () => {
    ...
    it.skip('should create an instance of OrganizationAttribute', () => {
      cy.get(`[data-cy="attributeName"]`).type('every judgementally up');
      cy.get(`[data-cy="attributeName"]`).should('have.value', 'every judgementally up');

      cy.get(`[data-cy="attributeValue"]`).type('considering save kebab');
      cy.get(`[data-cy="attributeValue"]`).should('have.value', 'considering save kebab');
