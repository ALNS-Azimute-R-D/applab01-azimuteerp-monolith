...
describe('TownCity Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TownCityUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Province query and add missing value', () => {
      ...
      const province: IProvince = { id: 19928 };
      townCity.province = province;

      const provinceCollection: IProvince[] = [{ id: 14933 }];
    ...
    it('Should update editForm', () => {
      const townCity: ITownCity = { id: 456 };
      const province: IProvince = { id: 5545 };
      townCity.province = province;
