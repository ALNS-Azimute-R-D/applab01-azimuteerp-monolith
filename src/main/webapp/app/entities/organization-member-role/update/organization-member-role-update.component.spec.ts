...
describe('OrganizationMemberRole Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, OrganizationMemberRoleUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call OrganizationMembership query and add missing value', () => {
      ...
      const organizationMembership: IOrganizationMembership = { id: 16568 };
      organizationMemberRole.organizationMembership = organizationMembership;

      const organizationMembershipCollection: IOrganizationMembership[] = [{ id: 13724 }];
    ...
    it('Should call OrganizationRole query and add missing value', () => {
      const organizationMemberRole: IOrganizationMemberRole = { id: 456 };
      const organizationRole: IOrganizationRole = { id: 11234 };
      organizationMemberRole.organizationRole = organizationRole;

      const organizationRoleCollection: IOrganizationRole[] = [{ id: 13944 }];
    ...
    it('Should update editForm', () => {
      const organizationMemberRole: IOrganizationMemberRole = { id: 456 };
      const organizationMembership: IOrganizationMembership = { id: 12896 };
      organizationMemberRole.organizationMembership = organizationMembership;
      const organizationRole: IOrganizationRole = { id: 28905 };
      organizationMemberRole.organizationRole = organizationRole;
