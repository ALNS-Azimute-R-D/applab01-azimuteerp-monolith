...
describe('Locality Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, LocalityUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Country query and add missing value', () => {
      ...
      const country: ICountry = { id: 14198 };
      locality.country = country;

      const countryCollection: ICountry[] = [{ id: 14399 }];
    ...
    it('Should update editForm', () => {
      const locality: ILocality = { id: 456 };
      const country: ICountry = { id: 3520 };
      locality.country = country;
