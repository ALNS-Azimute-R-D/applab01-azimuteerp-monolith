...
type ProductFormDefaults = Pick<NewProduct, 'id' | 'discontinued' | 'suppliersLists'>;
...
type ProductFormGroupContent = {
  ...
  suppliersLists: FormControl<IProduct['suppliersLists']>;
};
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      suppliersLists: new FormControl(productRawValue.suppliersLists ?? []),
    });
  }
