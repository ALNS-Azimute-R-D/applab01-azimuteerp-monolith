...
describe('Order Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Invoice query and add missing value', () => {
      ...
      const invoice: IInvoice = { id: 16612 };
      order.invoice = invoice;

      const invoiceCollection: IInvoice[] = [{ id: 31820 }];
    ...
    it('Should call Customer query and add missing value', () => {
      const order: IOrder = { id: 456 };
      const customer: ICustomer = { id: 12218 };
      order.customer = customer;

      const customerCollection: ICustomer[] = [{ id: 10353 }];
    ...
    it('Should update editForm', () => {
      const order: IOrder = { id: 456 };
      const invoice: IInvoice = { id: 12811 };
      order.invoice = invoice;
      const customer: ICustomer = { id: 28491 };
      order.customer = customer;
