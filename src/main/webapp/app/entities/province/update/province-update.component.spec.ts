...
describe('Province Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProvinceUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Country query and add missing value', () => {
      ...
      const country: ICountry = { id: 12980 };
      province.country = country;

      const countryCollection: ICountry[] = [{ id: 15544 }];
    ...
    it('Should update editForm', () => {
      const province: IProvince = { id: 456 };
      const country: ICountry = { id: 11394 };
      province.country = country;
