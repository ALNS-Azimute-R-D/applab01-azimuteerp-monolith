...
public class Organization implements Serializable {
    ...
    public Organization mainContactPersonDetails(String mainContactPersonDetails) {
    ...
    public Organization technicalEnvironmentsDetails(String technicalEnvironmentsDetails) {
    ...
    public Organization commonCustomAttributesDetails(String commonCustomAttributesDetails) {
