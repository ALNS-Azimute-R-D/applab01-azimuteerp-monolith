...
import de.org.dexterity.azimuteerp.monolith.domain.enumeration.ContinentEnum;
...
public class Country implements Serializable {
    ...
    private Set<Locality> localitiesLists = new HashSet<>();
    ...
    public Set<Locality> getLocalitiesLists() {
        return this.localitiesLists;
    }

    public void setLocalitiesLists(Set<Locality> localities) {
        if (this.localitiesLists != null) {
            this.localitiesLists.forEach(i -> i.setCountry(null));
        }
        if (localities != null) {
            localities.forEach(i -> i.setCountry(this));
        }
        this.localitiesLists = localities;
    }

    public Country localitiesLists(Set<Locality> localities) {
        this.setLocalitiesLists(localities);
        return this;
    }

    public Country addLocalitiesList(Locality locality) {
        this.localitiesLists.add(locality);
        locality.setCountry(this);
        return this;
    }

    public Country removeLocalitiesList(Locality locality) {
        this.localitiesLists.remove(locality);
        locality.setCountry(null);
        return this;
    }
